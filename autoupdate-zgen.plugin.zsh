...
system_seconds=$(expr ${day_seconds} \* ${ZGEN_SYSTEM_UPDATE_DAYS})
plugins_seconds=$(expr ${day_seconds} \* ${ZGEN_PLUGIN_UPDATE_DAYS})

last_plugin=$(check_interval ${ZGEN_PLUGIN_RECEIPT_F})
last_system=$(check_interval ${ZGEN_SYSTEM_RECEIPT_F})
...
unset ZGEN_PLUGIN_RECEIPT_F
unset ZGEN_PLUGIN_UPDATE_DAYS
unset ZGEN_SYSTEM_RECEIPT_F
unset ZGEN_SYSTEM_UPDATE_DAYS
unset day_seconds
unset last_plugin
unset last_system
